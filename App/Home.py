...
# Arrière-plan avec l'image (chemin relatif)
st.markdown(
"""
 <style>
...
# Bouton "Démarrer" qui redirige vers une autre page
# Liste des utilisateurs autorisés (à synchroniser avec Dashboard.py)
USERS = {
    "reda": "123",
    "rydouane": "123"
}
